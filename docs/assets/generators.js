      ...
      var DataProcessingAgreementGenerator = class {
        ...
        normalizeInput(input) {
          ...
          const messages = data.settings.language === "es" ? {
            ...
            missingDataSubjects: "Conviene indicar qu\xE9 categor\xEDas de titulares o usuarios est\xE1n involucradas.",
            missingSecurityMeasures: "Conviene resumir medidas t\xE9cnicas y organizativas de seguridad.",
            missingDeletionPeriod: "Conviene indicar qu\xE9 pasa con los datos al finalizar el servicio.",
            subprocessorsNeedMethodology: "Si us\xE1s subencargados o subprocessors, conviene explicar c\xF3mo se autorizan y controlan.",
      ...
      var AiPolicyGenerator = class {
        ...
        normalizeInput(input) {
          ...
          const messages = data.settings.language === "es" ? {
            ...
            missingSystems: "Conviene identificar qu\xE9 sistemas o funciones de IA se usan.",
            missingUseCases: "Conviene describir para qu\xE9 se usa la IA en el servicio.",
            missingTrainingDisclosure: "Deb\xE9s aclarar si los datos se usan o no para entrenamiento, ajuste, evaluaci\xF3n o mejora de modelos.",
            missingDataSources: "Conviene indicar de d\xF3nde provienen los datos vinculados al uso o entrenamiento de IA.",
            missingOptOutMethod: "Si ofrec\xE9s opt-out sobre entrenamiento o mejora, conviene indicar el m\xE9todo concreto.",
            missingRetention: "Conviene indicar cu\xE1nto tiempo se retienen prompts, outputs o datasets relacionados con IA.",
