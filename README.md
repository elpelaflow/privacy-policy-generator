...
- document-specific presets for privacy, terms, cookies, refund, EULA, security, DPA, and AI policy setup
...
- apply document-specific presets for `privacy`, `terms`, `cookies`, `refund`, `eula`, `security`, `dpa`, and `ai`
